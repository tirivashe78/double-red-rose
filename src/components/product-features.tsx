...
const INGREDIENTS: Ingredient[] = [
  ...
  },
  {
    ...
    short:
      "Citrus support for circulation, respiratory comfort, and metabolism.",
    conditions: [
      "Stroke risk reduction (supports circulation)",
      "Cardiovascular",
      "Asthma",
      "Obesity",
    ],
  ...
  },
  {
    ...
    short:
      "Natural humectant and wound/respiratory soother with broad traditional uses.",
    conditions: [
      "Wounds & skin issues",
      "Coughs & respiratory",
      "Digestive support",
    ...
    >
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mt-2 text-gray-600 max-w-2xl mx-auto">
          A thoughtfully selected blend of red superfruits, roots and natural
          extracts aimed at supporting skin, eyes, circulation, digestion, and
          overall wellbeing.
        </p>
      </div>
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {ing.conditions.map((c, idx) => (
                        <span
                          key={idx}
                          className="text-xs px-2 py-1 rounded-md bg-gray-100 text-gray-800"
                        >
                          {c}
                        </span>
                      ))}
